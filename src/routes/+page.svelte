...
<div class="p-6 rounded-lg shadow-lg">
  <h1 class="mb-4 text-2xl font-bold text-center text-white-800">
    Testing Station Realtime Data
  </h1>

  <div
    class="flex flex-col justify-between p-4 mb-4 bg-gray-700 rounded-lg shadow-inner sm:flex-row sm:items-center"
  >
    <div
      class="flex flex-col w-full sm:flex-row sm:space-x-4 sm:items-center sm:w-auto"
    >
      <div
        class="p-4 mb-2 text-sm text-white bg-blue-500 rounded-lg shadow transition-colors duration-300 sm:mb-0 hover:bg-violet-800"
      >
        <p class="font-semibold">First Measurement Time: {firstMeasurementTime ? firstMeasurementTime : "N/A"}</p>
      </div>
      <div
        class="p-4 mb-2 text-sm text-white bg-blue-500 rounded-lg shadow transition-colors duration-300 sm:mb-0 hover:bg-violet-800"
      >
        <p class="font-semibold">Last Fetch Time: {lastFetchTime ? lastFetchTime : "N/A"}</p>
      </div>
    </div>
    <div
      class="p-4 mt-2 text-sm text-white bg-green-500 rounded-lg shadow transition-colors duration-300 hover:bg-green-700 sm:mt-0 sm:ml-auto"
    >
      <p class="font-semibold">Total Measuring Time: {calculateMeasuringTime(firstMeasurementTime, lastFetchTime)}</p>
    </div>
  </div>
  ...
  <div class="flex justify-center mt-8">
    <button
      ...
      class="px-6 py-3 text-lg font-semibold text-white bg-blue-500 rounded-lg shadow-lg transition-colors duration-300 hover:bg-violet-800"
    >
      Export to CSV
    </button>
  </div>
